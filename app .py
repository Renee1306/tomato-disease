...
cnn_model = tf.keras.models.load_model("CNN.h5", custom_objects={'SEBlock': SEBlock})
...
class_names = [
    ...
    'Tomato Yellow Leaf Curl Virus', 'Tomato Mosaic Virus', 'Healthy','Powdery Mildew']
